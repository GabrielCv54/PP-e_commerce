...
export default function NavBar(){
    ...
    return (
       ...
       <div className="right-0 static "><a href="/clientes/login" id="login" className="font-extralight text-cyan-200">{clientName =="login"? "Faça seu login": ` ${clientName}`} </a><br />{clientName !="login" &&<button onClick={handleLogout} className="bg-red-500 p-3 rounde-lg font-bold absolute right-0" id="logout"> Sair</button> 
       } 
       </div></>
    )
}